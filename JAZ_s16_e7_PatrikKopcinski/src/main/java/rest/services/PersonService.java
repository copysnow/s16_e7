...
public class PersonService {
	...
	public Response update(@PathParam("id") int id, 
		...
		PersonDto updateAPerson = em.find(PersonDto.class, id);
	    if (person == null) {
	        throw new WebApplicationException(404);
	    }

	    updateAPerson.setFirstName(person.getFirstName());
		updateAPerson.setBirthday(person.getBirthday());
	    updateAPerson.setGender(person.getGender());
		updateAPerson.setLastName(person.getLastName());
	    updateAPerson.setEmail(person.getEmail());
		updateAPerson.setAge(person.getAge());
